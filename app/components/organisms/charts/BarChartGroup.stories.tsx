...
export const CategoricalSeries: Story = {
    ...
    args: {
        data: {
            labels: CATEGORIES,
            datasets: [
                { label: 'Site A', data: [4, 3, 5, 2, 4], backgroundColor: hexAlpha(SERIES_COLORS[0], 0.88), borderColor: SERIES_COLORS[0], borderWidth: 1, borderRadius: { topLeft: 4, topRight: 4 }, borderSkipped: 'bottom' as const },
                { label: 'Site B', data: [2, 4, 3, 3, 2], backgroundColor: hexAlpha(SERIES_COLORS[1], 0.88), borderColor: SERIES_COLORS[1], borderWidth: 1, borderRadius: { topLeft: 4, topRight: 4 }, borderSkipped: 'bottom' as const },
                { label: 'Site C', data: [1, 1, 2, 2, 1], backgroundColor: hexAlpha(SERIES_COLORS[3], 0.88), borderColor: SERIES_COLORS[3], borderWidth: 1, borderRadius: { topLeft: 4, topRight: 4 }, borderSkipped: 'bottom' as const },
            ],
        },
        options: {
            ...BASE_OPTIONS,
